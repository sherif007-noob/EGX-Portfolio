...
| 6 | Mobile / responsive refinement | **In progress — Pass 1 implemented; awaiting mobile validation** |
...
**Status: IN PROGRESS — Pass 1 implemented and CI-clean; awaiting mobile validation before Pass 2.**
