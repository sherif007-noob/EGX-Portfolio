...
| 5 | Advanced effects | **In progress — Pass 4 implemented; awaiting visual validation** |
...
**Status: IN PROGRESS — Pass 4 implemented and CI-clean; awaiting visual validation before final Pass 5.**
