...
| 8 | **In progress** | Passes 8.0–8.2 complete; 8.3 dense workflow hierarchy implemented, validation pending. |
...
- **d73ec82 / 42fb7ac / 43035ff / 10ad620 / edb9e33 / 5cb9563 / 2a765f4** — implement Pass 8.3 dense workflow hierarchy across Positions, Closed Cycles, Transactions, Cash Ledger, and Stocks. Summary/context stays H2/H3, controls become H4, table/list data becomes H5, and repeated semantic records use edge coding instead of full-card halo. All workflow behavior remains unchanged; regression coverage locks the summary → controls → dense-data contract.
